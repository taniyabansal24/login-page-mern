...
const Signup = () => {
  ...
  const handelSignup = async(e) =>{
    ...
    try{
        const url = "https://login-page-mern-api.vercel.app/auth/signup";
  ...
  const handelBothSubmit = async (e) => {
    e.preventDefault();
    const signupSuccess = await handelSignup(e);
    ...
    <div className="container">
      ...
      <div className="content">
        ...
        <div className="buttons">
          ...
          <a className="new-customer bigscreen" href="/login">
      ...
      <div className="main">
        ...
        <a className="new-customer smallscreen" href="/login">
            Already have an account?
          </a>
      </div>
      <ToastContainer />
